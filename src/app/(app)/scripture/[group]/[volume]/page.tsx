...
import { formatDisplayTitle, formatScriptureTitle } from '@/lib/titleFormatting';
import {
  getChosung,
  resolveActualTitle,
  getScriptureGroupBase,
  setReadStateIfHigher,
  setLastVolume,
  setLastGlobal,
...
export default function ScriptureReaderPage() {
  ...
  const handleSelectionAsk = () => {
    ...
    setAskModalCitation({
      text,
      titleClean: formatScriptureTitle(resolvedTitle),
