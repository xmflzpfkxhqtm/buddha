...
export default function Home() {
  ...
  return (
<main className="min-h-screen w-full max-w-[430px] pb-[calc(2.25rem+env(safe-area-inset-bottom))] flex flex-col justify-start items-center mx-auto bg-[#F5F1E6] px-6 py-10">
